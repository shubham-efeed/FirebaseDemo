...
class IncrementDecrementButton @JvmOverloads constructor(
    ...
    private var changeCallback : ((Int)->Unit)? = null;
    // attributes
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            maxValue=getInt(R.styleable.IncrementDecrementButton_maxValue, DEFAULT_MAX_VALUE)-1
            cornerRadius =
    ...
    private fun attachListeners() {
        btnIncrement.setOnClickListener {
            ...
            if (value<=maxValue){
                value++
                onIncrement()
                changeCallback?.invoke(Integer.valueOf(value))
            }
        }
